    ...
    public class AlerterTests {
        ...
        public void TestAlertInCelcius_NormalTemperature() {
            using (var sw = new StringWriter()) {
                ...
                Assert.AreEqual("ALERT: Temperature is 20 celcius", output);
                Assert.AreEqual(0, Alerter.alertFailureCount);
            }
        }
        ...
        public void TestAlertInCelcius_FreezingTemperature() {
            using (var sw = new StringWriter()) {
                ...
                var output = sw.ToString().Trim();
                Assert.AreEqual("ALERT: Temperature is 0 celcius", output);
                Assert.AreEqual(0, Alerter.alertFailureCount);
            }
        }
        ...
        public void TestAlertInCelcius_HighTemperature() {
            using (var sw = new StringWriter()) {
                ...
                var output = sw.ToString().Trim();
                Assert.AreEqual("ALERT: Temperature is 37.77777777777778 celcius", output);
                Assert.AreEqual(0, Alerter.alertFailureCount);
            }
        }
        ...
        public void TestAlertInCelcius_FailureSimulation() {
            ...
            using (var sw = new StringWriter()) {
                ...
                Assert.AreEqual(1, Alerter.alertFailureCount);
            }
        ...
        public void TestAlertInCelcius_NegativeTemperature() {
            using (var sw = new StringWriter()) {
                ...
                var output = sw.ToString().Trim();
                Assert.AreEqual("ALERT: Temperature is -17.77777777777778 celcius", output);
                Assert.AreEqual(0, Alerter.alertFailureCount);
            }
        }
    }
